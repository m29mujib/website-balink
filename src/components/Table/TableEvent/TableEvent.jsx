...
import Gambar from '../../../assets/assetsLandingPage/wisata.svg'
import Modal from "react-modal";
import konfirmasi from "../../../assets/images/konfirmasi.png";
import close from "../../../assets/icons/close.svg";
import check from "../../../assets/icons/check.svg";
import deleteImg from "../../../assets/icons/delete1.png";
...
const TableEvent = ({ data }) => {
  ...
  const deleteProduk = () => {
    del(`https://6481c62b29fa1c5c50320b9a.mockapi.io/balink/event/${selectedId}`)
      .then(() => {
        openTerhapusModal();
      })
      .catch((error) => {
